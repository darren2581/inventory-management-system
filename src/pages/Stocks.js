    ...
    <div className={`App ${isSidebarCollapsed ? 'collapsed' : ''}`}>
      ...
      <main>
        <div className="container">
          ...
          <p>
            The Stock section helps you manage the available products in your system. Here you can track products that are in stock, low in stock, or out of stock.
          </p>
          ...
          <section className="update-stock">
            ...
            <form>
              ...
              <input type="number" placeholder="Enter new stock level" />
              <label>Status:</label>
              <select>
